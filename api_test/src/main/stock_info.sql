...
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 9.0\\Uploads\\stock_data.csv' #파일을 여기에 옮겨야 함
    INTO TABLE stock_info
    FIELDS TERMINATED BY ','
    ENCLOSED BY '"'
    LINES TERMINATED BY '\n'
    IGNORE 1 LINES
    (`index`, standard_code, short_code, kr_stock_nm, kr_stock_abbr,market);
